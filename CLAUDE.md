...
`assets/` holds what the README embeds and `.github/` what GitHub reads; the tooling that produces
both lives in `scripts/demo/`, which rebuilds `assets/demo.gif` and `.github/social-preview.png`
